...
<div class="container">
  <div class="form-container flip">
	...
	<?php
	echo "<div>
	<p class='imagep'><img src = 'getimage.php?varname=".$userid."' width='200' height = '200'/><p>
	</div>"
	?>
		<div class="display-id" id="username">
        <p class="profile-display"><strong> <?php echo $userid ?><strong></p>
        </div>
		
		
	<div class="form-group" id="email">
        <input class="form-input" type = "email" tooltip-class="email-tooltip" placeholder="E-mail" name = "email" value = "<?php echo $email ?>" ></input>
        <span id="email-tool"class="tooltip email-tooltip">Enter Your new Email Id</span>
		</div>
		
	<div class="form-group" id="DOB">
        <input class="form-input" type="date" name = "DOB" tooltip-class="DOB-tooltip" value = "<?php echo $dob ?>"></input>
        <span id="DOB-tool"class="tooltip DOB-tooltip">Select your new DOB</span>
	</div>
	
	<div class="form-select" id="country">
        <select id = "country" type = "select" class="form-input" tooltip-class="Country-tooltip" name = "country" >
    ...
    <option value="Zimbabwe">Zimbabwe</option>
        ...
        <span id="Country-tool"class="tooltip Country-tooltip">Select your Country</span>
	</div>
	...
	<span id="profilepic-tool"class="tooltip profilepic-tooltip">upload profile picture</span>
      ...
      <div class="form-group">
		...
		<input class="login-button" name="update" type="submit" value="Update" onclick="return confirm('Confirm Update?')">>
